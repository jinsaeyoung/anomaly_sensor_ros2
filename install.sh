...
pip3 install pyusb pyaudio numpy pyserial -q
echo "✅ Python 의존성 설치 완료"

# ── 4. GeographicLib 데이터 설치 ─────────────────────────────────────────
echo "[4/6] GeographicLib 데이터 설치..."
